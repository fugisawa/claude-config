# Perfil operacional e semana-modelo

Sumário: Regras do perfil · Orçamento e semana-modelo · Dia furado e DMV · Protocolos P1–P15 · Se-então pré-decididos · Sinais que roteiam ao kit

Fonte: *Plano de 18 Meses* e *Arranque* (jun/2026). Estas regras valem em **qualquer** plano gerado — não são opcionais nem negociáveis semana a semana.
...
Tetos de foco (planejar blocos dentro deles): Anki 10–15 min · matemática/cálculo 40–50 min · bloco longo (90–120 min) só alternando atividades. Máximo 2–3 matérias por dia; intercalação **entre dias**, não dentro do dia.

## Orçamento e semana-modelo
...
| Slot | Conteúdo | Tipo |
|---|---|---|
| 6h10–7h15 | **Pico**: teoria nova pesada, com autoexplicação em voz alta; fecha gerando 2–3 cartões de aplicação | Absorção profunda |
| 7h45–8h05 | Deslocamento: só áudio (lei seca da véspera, resumo) | Revisão passiva |
| Manhã · sala (~1h) | 20–30 questões da banca no tópico da manhã | Execução |
| ~10h30–11h15 | Movimento **sem suor** (~4 h pós-pico): kettlebell 10 min, caminhada | Consolidação |
| 12h10–12h42 | Power nap 15–20 min + ATT ~12 min (primer de foco da tarde; nunca à noite) | Recuperação |
| Tarde · sala (~1h) | Caderno de erros: classificar (C/M/L/D/N) e reabrir teoria só do que errou | Correção |
| 17h45–18h05 | Deslocamento: áudio | Revisão passiva |
| 18h15–19h10 | Yoga | Regulação |
| 19h45–20h45 | Anki/FSRS do dia + fechar caderno de erros + microdose da matéria fraca | Reforço |
| 21h50 · 22h–6h | Telas off · sono 8 h | Consolidação |

Fim de semana: **Sáb** 7h30–9h teoria/matéria fraca · 10h–11h30 simulado cronometrado (quando a cadência pedir) · 11h30–12h15 correção por taxonomia + cartões · 15h–16h questões intercaladas (2–3 matérias). **Dom** 8h–9h30 discursiva sob tempo · 10h30–11h30 revisão (Anki atrasado + caderno de erros — não a teoria) · 11h30–12h **check-in/planejamento** · tarde livre (parte da sustentabilidade, não folga culpada). **Quinta (terapia): meta = piso, por definição — está previsto, não é fracasso.**

Regras do slot: teoria difícil só no pico, nunca após dia cansativo; a sala é sala de **questões**, nunca de teoria nova (interrupções do expediente travariam e contaminariam o lugar); exercício que faz suar fica na manhã do fim de semana, nunca à noite (batimento demora a baixar e rouba o sono).

> Treinos e yoga podem ter mudado de horário desde jun/2026 — **confirme as janelas no check-in** antes de fixar relógio. Os slots e a ordem valem; o horário exato ajusta.

## Dia furado e DMV

Imprevisto **rebaixa**, nunca cancela — e o nível já está pré-decidido (decidir sob estresse é o que trava). No fundo da escala, o **Dia Mínimo Viável (~20 min, sempre igual): 15 questões da banca + Anki que vencer no dia + 1 linha no caderno de erros.** É uma ação completa com primeiro passo óbvio. Fez o DMV → dia verde, corrente intacta. Frequentemente o começar destrava e ele segue; se parar nos 20 min, já venceu o dia.
...
| P5 | A-pior-primeiro | O bloco do pico recebe a matéria temida da vez, entrando pela compreensão, com dose-teto |
...
| P10 | Bloco longo monomatéria | 90–120 min por bloco; máx 2–3 matérias/dia; intercalação entre dias |
| P11 | Ritual de transição | Fechar A com bilhete "onde parei / próxima ação", pausa sem tela, abrir B com primeira ação definida |
| P12 | Sprint de compreensão | Hiperfoco autorizado como exceção planejada (sáb) para montar a lógica de uma matéria-chave, com teto e alarme |
| P13 | Trava antidesbalanceamento | Teto semanal por matéria + check de cobertura no domingo + janela marcada para tangentes/outros interesses |
...
| Se | Então |
|---|---|
| Perdi o bloco da manhã | Pico migra para a 1ª fatia da sala; a sala vira teoria só nesse dia |
| Trabalho comeu as fatias da sala | Noite: 30 questões + Anki — conta como piso |

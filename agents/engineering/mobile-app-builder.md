...
description: Develops native iOS/Android and React Native apps — smooth scrolling feeds, push notifications, biometric auth, platform integration, and mobile performance and memory tuning.
color: green

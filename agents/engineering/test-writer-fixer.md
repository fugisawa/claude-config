...
description: Writes new tests, runs the suite, analyzes failures, and fixes them without weakening assertions. Use proactively after any code change — new feature, refactor, bug fix — and for modules that lack coverage.
color: cyan
---

...
description: Reviews code for architectural consistency — SOLID principles, layering, service boundaries, dependencies, maintainability. Use on pull requests with significant structural changes or when adding a new service.
color: gray
model: opus
---

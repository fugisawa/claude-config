...
description: Analyzes user feedback across sources (app store reviews, support tickets, surveys) to find patterns, extract pain points, and prioritize features from real user demand rather than assumptions.
color: orange

...
description: Plans 6-day development cycles — feature prioritization, roadmap trade-offs, ROI comparison between competing features, and rebalancing when scope changes mid-sprint.
color: indigo

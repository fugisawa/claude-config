---
name: tool-evaluator
description: Evaluates new development tools, frameworks, and services — rapid assessment, comparative analysis, and a fit recommendation for the 6-day development cycle.
color: purple

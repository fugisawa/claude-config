...
description: PROACTIVELY use when experiments or feature flags are introduced, modified, or ready for analysis. Tracks A/B tests and feature experiments — success metrics, checkpoints, and keep/kill decisions backed by data.
color: blue

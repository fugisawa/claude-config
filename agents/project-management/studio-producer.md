...
description: PROACTIVELY use when coordinating across teams, allocating scarce resources, or fixing workflow bottlenecks. Handles cross-functional handoffs, team capacity planning, process optimization, and sprint kickoffs.
color: green

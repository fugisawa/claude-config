...
description: Analyzes code repositories, technical docs, and implementation details — GitHub projects, API docs, code examples, code quality, version history, comparing implementations. Use to evaluate a library, framework, or technical approach.

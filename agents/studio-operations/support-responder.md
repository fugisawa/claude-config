...
description: Handles customer support — inquiry responses, support documentation, automated response setup, and analysis of support patterns to surface product improvements.
color: green

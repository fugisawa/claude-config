...
description: Reviews legal and regulatory compliance for apps — GDPR, HIPAA health data, COPPA and children's in-app purchases, AI disclosure requirements, terms of service and privacy policies.
color: red

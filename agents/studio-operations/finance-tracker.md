...
description: Manages budgets and financial performance — budget allocation and ROI, unit economics and path to profitability, monetization model comparison (ads vs subscription), burn rate and runway reporting.
color: orange

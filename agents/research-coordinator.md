...
description: Plans and allocates complex research across multiple specialist researchers — decomposes requirements, assigns tasks, and defines iteration strategy for full coverage. Use for multi-faceted research needing several specialists.

...
description: Turns data and concepts into visual narratives — infographics, pitch decks, onboarding illustrations, and visual metaphors that explain complex features. Use to communicate an idea through imagery.
color: cyan

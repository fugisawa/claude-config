---
name: ux-researcher
description: Conducts user research and validates design decisions — user needs and pain points, journey maps, personas, onboarding drop-off and friction analysis, usability testing. Use to replace guesswork with behavior data.
color: purple

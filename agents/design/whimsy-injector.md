...
description: PROACTIVELY use after any UI/UX change to add delight — playful microcopy, memorable loading and empty states, error messages that reduce frustration, shareable moments. Trigger automatically when interfaces or design are updated.
color: yellow

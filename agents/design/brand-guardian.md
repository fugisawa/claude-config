---
name: brand-guardian
description: Establishes and maintains brand identity — visual guidelines, cross-platform consistency (iOS/Android/web), brand asset libraries and color usage, and brand modernization. Use when defining or evolving a brand.
color: indigo

...
description: Runs an end-to-end research project across multiple specialized agents in sequence, from query clarification through final report. Use for broad or vague research requests needing a structured multi-phase process.

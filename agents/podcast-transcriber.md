...
description: Extracts accurate transcripts from audio/video — FFMPEG format conversion, timestamped segments, speaker identification, and structured transcript output. Also transcribes a specific time range of a file.
model: opus

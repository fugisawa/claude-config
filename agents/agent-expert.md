---
name: agent-expert
description: Creates and refines specialized Claude Code agents — agent design, prompt engineering, domain-expertise modeling, and agent file structure. Use when writing a new agent or improving an existing one's prompt or boundaries.
color: orange
---

...
description: Turns synthesized research findings into a comprehensive final report — readable narrative, logical structure, proper citations. Use as the last step of a research process, after findings are gathered and synthesized.
